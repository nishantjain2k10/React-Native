...
class Example extends Component {
    ...
    setFirstMenuDisabled(disabled) {
        this.setState({
            message: `First menu is ${disabled
                ? 'disabled'
                : 'enabled'}`,
        ...
        return (
            <MenuContext style={{
                ...
                <View style={styles.topbar}>
                    <Menu onSelect={this.setMessage.bind(this)}>
                ...
                <View style={[
                    ...
                    <Menu onSelect={this.setFirstMenuDisabled.bind(this)}>
                ...
                <View style={styles.content}>
                    ...
                    <Menu style={styles.dropdown} onSelect={(value) => this.setState({dropdownSelection: value})}>
                        ...
                        <MenuOptions optionsContainerStyle={styles.dropdownOptions} renderOptionsContainer={(options) => <ScrollView>
                            <Text>CHOOSE SOMETHING....</Text>{options}</ScrollView>}>
