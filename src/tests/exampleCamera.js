    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Camera ref={(cam) => {
                    this.camera = cam;
                }} style={styles.preview} aspect={this.state.camera.aspect} captureTarget={this.state.camera.captureTarget} type={this.state.camera.type} flashMode={this.state.camera.flashMode} onBarCodeRead ={this.onBarCodeRead} defaultTouchToFocus mirrorImage={false}/>
                ...
                <View style={[styles.overlay, styles.bottomOverlay]}>
                    ...
                    <View style={styles.buttonsSpace}/> {!this.state.isRecording && <TouchableOpacity style={styles.captureButton} onPress={this.startRecording}>
